...
# load data
load("data/FileS1_dosepruned.Rda")
...
load("data/FileS2_riailpheno.Rda")
...
parta <- cowplot::ggdraw() +
  cowplot::draw_image("figures/supp/partA.png")

partb <- cowplot::ggdraw() +
  cowplot::draw_image("figures/supp/partB.png")
...
# load data
load("data/FileS10_set1_mappingdf.Rda")
